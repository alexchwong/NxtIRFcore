...
#' work on Linux-based systems with STAR installed (and accessible via $PATH)
#'
...
#' @param mappability_reads_fasta The path to the FASTA file containing reads
...
#' @param sjdbOverhang A STAR setting indicating the length of the donor / 
