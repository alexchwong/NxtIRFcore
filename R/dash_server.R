dash_server = function(input, output, session) {
    ...
    get_se_reactive <- reactive(settings_expr_load$se)   # NxtSE object
    get_de_reactive <- reactive(settings_DE$res)    # Differential expression
    ...
    get_rows_all <- reactive(settings_DE$DT_DE_rows_all)    # Filtered DE rows
