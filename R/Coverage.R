...
#'   `covfile(se) <- vector_of_cov_files`. `se` is optional in `Plot_Genome` but
#'   is required by `Plot_Coverage`. If `se` is not given in `Plot_Genome`, 
#'   `reference_path` is required
#' @param reference_path The path of the reference generated by 
#'   `BuildReference()`. Only required by `Plot_Genome` if a NxtSE object is
#'   not specified.
...
#'   instead of `seqname,start,end`. Must be of the format e.g. 
#'   "chr1:10000-11000"
...
#' @describeIn Plot_Coverage generates a coverage plot illustrating differential
#' expression of intron retention or alternative splicing (differential exon
#' coverage). It can normalise coverage of samples per condition using NxtIRF's
#' SpliceOver parameter that normalises the flanking exon boundaries to 1.
#' @export
