...
# Events when directories are filled:
    ...
    observeEvent(settings_expr$collate_path, {
        if(is_valid(settings_expr$collate_path) && file.exists(file.path(
