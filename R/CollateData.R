...
#'
#' @param Experiment A 2 or 3 column data frame (generated by [Find_Samples()]),
...
#'   splice reads.
#' @param samples_per_block How many samples to process per thread, maximum.
...
.collateData_junc_merge <- function(df.internal, jobs, BPPARAM_mod, 
    ...
    .log("merging...", "message", appendLF = FALSE)
    junc.common = NULL
...
# Annotates splice junctions for flanking exon islands
...
.collateData_process_splice <- function(junc, irf,
        Splice.Anno) {
