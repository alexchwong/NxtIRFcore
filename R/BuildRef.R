...
#' @param overwrite (default FALSE) `GetReferenceResource()` if the genome FASTA
#'   and gene annotation GTF files already exist in `resource` subdirectory,
#'   it will not be overwritten. In `BuildReference()` and 
