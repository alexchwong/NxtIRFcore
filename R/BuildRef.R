...
#'   running `GenerateMappabilityReads()` on the genome sequence, followed by 
...
#'   `GenerateMappabilityBED()`, which will provide the Mappability file to be 
#'   used here.
...
#' \cr\cr
#' First, using `GenerateMappabilityReads()`,
...
#' using `GenerateMappabilityBED()`, to identify
...
#'   to the given `reference_path`. `GenerateMappabilityBED()` writes
