...
Firstly, retrieve the BAM files from ExperimentHub using the NxtIRFdata helper
function `example_bams()`
...
This will load the BAM path and make a local copy at `bam_path`.

Next, we need to assign sample names to these BAM files. 
